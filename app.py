...
if submitted:
    ...
    prompt = f"""
    You are a senior GenAI presales consultant.

    Generate a structured deal brief for the following opportunity.
    ...
    Keep the response professional, concise, and enterprise-focused.
    """
    ...
    with st.spinner("Generating deal brief..."):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are an expert enterprise GenAI presales strategist."
                },
                {
                    "role": "user",
                    "content": prompt
